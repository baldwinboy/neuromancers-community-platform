...
- The runtime application keys listed in `iac/docs/coolify-env-mapping.md`
...
- Do not use `server-bootstrap.sh` as the standard deployment path.
...
9. Pin Ansible collection versions in `iac/galaxy/requirements.yml` for reproducible deploys.
